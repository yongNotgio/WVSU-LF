    ...
    <div className="fixed bottom-6 right-6 w-[320px] bg-white border-2 border-wvsu-blue z-[100] shadow-[6px_6px_0_var(--blue)]">
      ...
      {challengeStatus === "pending" && isItemPoster && (
        <div className="p-3 bg-[#fff8e1] border-b border-wvsu-gold space-y-2">
          <div className="text-[10px] font-bold uppercase tracking-wider text-wvsu-muted font-mono">
            🔒 Claim Review
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={verifying}
              className="flex-1 bg-found-green text-white py-2 text-xs font-bold uppercase tracking-wider hover:bg-found-green/90 disabled:opacity-50"
            >
              ✅ Accept
            </button>
            <button
              ...
              disabled={verifying}
              className="flex-1 bg-lost-red text-white py-2 text-xs font-bold uppercase tracking-wider hover:bg-lost-red/90 disabled:opacity-50"
            >
              ❌ Mismatch
            </button>
          </div>
